    ...
    return (
        <>
            <Spotlight
                ...
                height="90vh"
            />
            <div className="font-ibm flex flex-col items-center p-2 lg:p-4 space-y-8">
                ...
                <div className="flex flex-col w-full lg:flex-row space-x-0 space-y-8 lg:space-x-8 lg:space-y-0 z-50 mt-8">
                    <div className="flex flex-col w-full lg:w-1/2 items-center">
                                ...
                                <div className="flex flex-col space-y-2">
                                    <div className="relative">
                                        <input
                                            ...
                                            type="text"
                                            placeholder="Nombre"
                                            className={`w-full p-3 rounded-lg border-2 outline-none focus:ring-2 focus:ring-opacity-50
                      ...
                      ${errors.nombre ? 'border-red-500 focus:border-red-500 focus:ring-red-300' : ''}`}
                                        />
                                        {errors.nombre && (
                      ...
                      dark:bg-neutral-900 dark:border-neutral-700 dark:focus:border-neutral-500 dark:focus:ring-neutral-400
                      bg-white border-neutral-600 focus:border-gray-400 focus:ring-gray-300
                      ${errors.correo ? 'border-red-500 focus:border-red-500 focus:ring-red-300' : ''}`}
                                        />
                                        {errors.correo && (
                                ...
                                <div className="flex flex-col space-y-2">
                                    <div className="relative">
                                        <textarea
                                            ...
                                            className={`w-full p-3 rounded-lg border-2 outline-none focus:ring-2 focus:ring-opacity-50
                      dark:bg-neutral-900 dark:border-neutral-700 dark:focus:border-neutral-500 dark:focus:ring-neutral-400
                      bg-white border-neutral-600 focus:border-gray-400 focus:ring-gray-300 resize-none
                      ${errors.mensaje ? 'border-red-500 focus:border-red-500 focus:ring-red-300' : ''}`}
                                        />
                                        {errors.mensaje && (
                                ...
                                <div className="relative">
                                    {submitSuccess && (
                                        <div className="absolute -top-10 left-0 right-0 bg-green-500 text-white p-2 rounded-md text-center">
                    ...
                    bg-gradient-to-r border-2  dark:border-white border-neutral-600 dark:hover:bg-neutral-900 hover:bg-neutral-300
